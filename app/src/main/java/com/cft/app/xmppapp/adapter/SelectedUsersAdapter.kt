...
class SelectedUsersAdapter(private val context: Context,
                           private val list:ArrayList<String>,
                           private val onMyClickListener: OnMyClickListener): RecyclerView.Adapter<SelectedUsersAdapter.ViewHolder>() {
